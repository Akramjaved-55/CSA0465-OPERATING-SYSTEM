#include <stdio.h>
int search(int key, int frame_items[], int
frame_occupied)
{
...
int predict(int ref_str[], int frame_items[], int
refStrLen, int index, int frame_occupied)
{
...
void optimalPage(int ref_str[], int refStrLen, int
...
if (search(ref_str[i], frame_items,
frame_occupied)) {
hits++;
...
int pos = predict(ref_str, frame_items,
refStrLen, i + 1, frame_occupied);
...
optimalPage(ref_str, refStrLen, frame_items,
max_frames);
return 0;
}
